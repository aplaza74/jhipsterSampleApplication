package es.upcnet.web.rest;

import es.upcnet.config.Constants;
import es.upcnet.JhipsterSampleApplicationApp;
import es.upcnet.domain.Authority;
import es.upcnet.domain.User;
import es.upcnet.repository.AuthorityRepository;
import es.upcnet.repository.UserRepository;
import es.upcnet.security.AuthoritiesConstants;
import es.upcnet.service.MailService;
import es.upcnet.service.dto.UserDTO;
import es.upcnet.web.rest.errors.ExceptionTranslator;
import es.upcnet.web.rest.vm.KeyAndPasswordVM;
import es.upcnet.web.rest.vm.ManagedUserVM;
import es.upcnet.service.UserService;
