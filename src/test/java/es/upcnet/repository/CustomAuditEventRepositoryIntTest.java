package es.upcnet.repository;

import es.upcnet.JhipsterSampleApplicationApp;
import es.upcnet.config.Constants;
import es.upcnet.config.audit.AuditEventConverter;
import es.upcnet.domain.PersistentAuditEvent;
...
import static es.upcnet.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
